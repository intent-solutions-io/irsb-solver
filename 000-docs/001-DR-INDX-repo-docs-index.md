...
This index catalogs all documents in `000-docs/`. It is updated whenever documents are added, removed, or significantly modified.
...
- When a new document is added to `000-docs/`
- When a document is removed or archived
- When document purpose changes significantly

**Validation:** Run `ls 000-docs/*.md` and verify all files are listed above.
